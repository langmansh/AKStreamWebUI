#pragma checksum "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a15cfbb3f5107601c0e9a304a89fe98ffdb6d9c5"
// <auto-generated/>
...
#nullable disable
    ...
    public class Areas_OrganizationManage_Views_User_UserDetail : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
...
#nullable restore
#line 28 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
                                                                       Write(ViewBag.Ip);
...
#nullable restore
#line 56 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
...
#nullable restore
#line 61 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
...
#nullable disable
            WriteLiteral(@", result.Gender);
                        ...
                        if (ys.isNullOrEmpty(result.Portrait)) {
                            ...
                            result.Portrait = '");
#nullable restore
#line 68 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
    ...
    function getRoleName(roleIds) {
        if (!ys.isNullOrEmpty(roleIds)) {
            ys.ajax({
                url: '");
#nullable restore
#line 84 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
    ...
    function getPositionName(positionIds) {
        if (!ys.isNullOrEmpty(positionIds)) {
            ys.ajax({
                url: '");
#nullable restore
#line 98 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
    ...
    function getDepartmentName(id) {
        if (id > 0) {
            ys.ajax({
                url: '");
#nullable restore
#line 112 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
    ...
    function saveForm(index) {
        if ($(""#form"").validate().form()) {
            ...
            ys.ajax({
                url: '");
#nullable restore
#line 127 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
...
#nullable disable
    ...
    function showChangePasswordForm() {
        ys.openDialog({
            ...
            content: '");
#nullable restore
#line 147 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
...
#nullable disable
    ...
    function showChangeUserForm() {
        ys.openDialog({
            ...
            content: '");
#nullable restore
#line 158 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
...
#nullable disable
    ...
    function showUserAvatarForm() {
        ys.openDialog({
            ...
            content: '");
#nullable restore
#line 169 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\OrganizationManage\Views\User\UserDetail.cshtml"
