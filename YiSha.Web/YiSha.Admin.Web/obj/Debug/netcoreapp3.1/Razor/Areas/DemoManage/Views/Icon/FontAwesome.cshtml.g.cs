#pragma checksum "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\DemoManage\Views\Icon\FontAwesome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4a61aba127644db9281f65649586360d9c613599"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_DemoManage_Views_Icon_FontAwesome), @"mvc.1.0.view", @"/Areas/DemoManage/Views/Icon/FontAwesome.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4a61aba127644db9281f65649586360d9c613599", @"/Areas/DemoManage/Views/Icon/FontAwesome.cshtml")]
    ...
    public class Areas_DemoManage_Views_Icon_FontAwesome : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 1 "E:\源码\AKStreamWebUI\AKStreamWebUI\YiSha.Web\YiSha.Admin.Web\Areas\DemoManage\Views\Icon\FontAwesome.cshtml"
        ...
        <div class=""col-sm-12"">
            <div class=""ibox float-e-margins"">
                <div class=""ibox-content"">
                    <h2>FontAwesome</h2>
                    <p>
                        <a href=""https://fontawesome.com/v4.7.0/icons/"" target=""_blank"">FontAwesome</a> 提供丰富的矢量字体图标—通过CSS可以任意控制所有图标的大小，颜色，阴影。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class=""col-sm-12"">
            <section id=""new"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/address-book-o""><i class");
            WriteLiteral(@"=""fa fa-address-book-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>address-book-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bath""><i class=""f");
            WriteLiteral(@"a fa-bathtub"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bathtub <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/envelope-open""><i class=""fa fa-envelope-open"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>envelope-open</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/handshake-o""><i class=""fa fa-handshake-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </");
            WriteLiteral(@"span>handshake-o</a></div>
                 ...
                 ");
            WriteLiteral(@"   <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/meetup""><i class=""fa fa-meetup"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>meetup</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a h");
            WriteLiteral(@"ref=""../icon/bath""><i class=""fa fa-s15"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>s15 <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"m-4""><a href=""../icon/thermometer-full""><i class=""fa fa-thermometer"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 c");
            WriteLiteral(@"ol-sm-4""><a href=""../icon/thermometer-three-quarters""><i class=""fa fa-thermometer-3"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-3 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-half""><i clas");
            WriteLiteral(@"s=""fa fa-thermometer-half"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-half</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/window-close-o""><i class=""fa fa-times-rectangle-o"" aria-hidden=""true""></i> <span cla");
            WriteLiteral(@"ss=""sr-only"">Example of </span>times-rectangle-o <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"./icon/address-card-o""><i class=""fa fa-vcard-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>vcard-o <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/window-minimize""><i class=""fa fa-window-minimize"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>window-minim");
            WriteLiteral(@"ize</a></div>
            ...
            <section id=""web-application"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/address-book-o""><i class=""fa fa-address-book-o"" aria-hidden=""true""></i> ");
            WriteLiteral(@"<span class=""sr-only"">Example of </span>address-book-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-s");
            WriteLiteral(@"m-4""><a href=""../icon/anchor""><i class=""fa fa-anchor"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>anchor</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/arrows-v""><i cla");
            WriteLiteral(@"ss=""fa fa-arrows-v"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>arrows-v</a></div>
...
");
            WriteLiteral(@"                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/audio-description""><i class=""fa fa-audio-description"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>audio-description</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/university""><i class=""fa fa-bank"" aria-hidden=""true""></i> <span class=""sr-only"">Examp");
            WriteLiteral(@"le of </span>bank <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bath""><i class=""fa fa-bath"" aria-hidden=""true");
            WriteLiteral(@"""></i> <span class=""sr-only"">Example of </span>bath</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/battery-quarter""><i class=""fa fa-battery-1"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>battery-1 <span class=""text-muted"">(alias)</span></a><");
            WriteLiteral(@"/div>
            ...
            WriteLiteral(@"-4""><a href=""../icon/battery-full""><i class=""fa fa-battery-full"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>battery-full</a></div>
             ...
             ");
            WriteLiteral(@"       <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/beer""><i class=""fa fa-beer"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>beer</a></div>
            ...
            WriteLiteral(@"sm-4""><a href=""../icon/bicycle""><i class=""fa fa-bicycle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bicycle</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""..");
            WriteLiteral(@"/icon/bluetooth-b""><i class=""fa fa-bluetooth-b"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bluetooth-b</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bookmark-o""><i class=""fa fa-bookmark-o"" aria-hidde");
            WriteLiteral(@"n=""true""></i> <span class=""sr-only"">Example of </span>bookmark-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/building-o""><i class=""fa fa-building-o"" aria-hidden=""true""></i> <span class=""sr-only"">Ex");
            WriteLiteral(@"ample of </span>building-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/calculator""><i class=""fa fa-calculator"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </s");
            WriteLiteral(@"pan>calculator</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/calendar-plus-o""><i class=""fa fa-calendar-plus-o"" aria-hidden=""true"">");
            WriteLiteral(@"</i> <span class=""sr-only"">Example of </span>calendar-plus-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-down""><i class=""fa fa-caret-square-o-down"" aria");
            WriteLiteral(@"-hidden=""true""></i> <span class=""sr-only"">Example of </span>caret-square-o-down</a></div>
                  ...
                  ");
            WriteLiteral(@"  <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cart-plus""><i class=""fa fa-cart-plus"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cart-plus</a></div>
            ...
            WriteLiteral(@"col-sm-4""><a href=""../icon/check-circle-o""><i class=""fa fa-check-circle-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>check-circle-o</a></div>
            ...
            WriteLiteral(@"d-3 col-sm-4""><a href=""../icon/circle-o""><i class=""fa fa-circle-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>circle-o</a></div>
            ...
            WriteLiteral(@"<a href=""../icon/times""><i class=""fa fa-close"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>close <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3");
            WriteLiteral(@" col-sm-4""><a href=""../icon/code-fork""><i class=""fa fa-code-fork"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>code-fork</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/comment-o""><i class=""fa fa-comment");
            WriteLiteral(@"-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>comment-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/compass""><i class=""fa fa-compass"" ar");
            WriteLiteral(@"ia-hidden=""true""></i> <span class=""sr-only"">Example of </span>compass</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/crop""><i cl");
            WriteLiteral(@"ass=""fa fa-crop"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>crop</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/tachometer""><i class=""fa fa-dashboard"" aria-hidden=""true""></i> <span c");
            WriteLiteral(@"lass=""sr-only"">Example of </span>dashboard <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>diamond</a></div>
                   ...
                   ");
            WriteLiteral(@" <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/pencil-square-o""><i class=""fa fa-edit"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>edit <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/envelope-o""><i class=""fa fa-envelope-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>envelope-o</a><");
            WriteLiteral(@"/div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/exchange""><i class=""fa fa-exchange"" aria-hidden=""true""></i> <span class=""sr-only"">Example o");
            WriteLiteral(@"f </span>exchange</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/external-link-square""><i class");
            WriteLiteral(@"=""fa fa-external-link-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>external-link-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/rss""><i class=""fa fa-feed"" aria-hidden=""true");
            WriteLiteral(@"""></i> <span class=""sr-only"">Example of </span>feed <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-code-o"">");
            WriteLiteral(@"<i class=""fa fa-file-code-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-code-o</a></div>
                    ...
                    <div cla");
            WriteLiteral(@"ss=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-image-o""><i class=""fa fa-file-photo-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-photo-o <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""");
            WriteLiteral(@"../icon/file-video-o""><i class=""fa fa-file-video-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-video-o</a></div>
            ...
            WriteLiteral(@"md-3 col-sm-4""><a href=""../icon/fire""><i class=""fa fa-fire"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>fire</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""");
            WriteLiteral(@"><a href=""../icon/bolt""><i class=""fa fa-flash"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>flash <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a h");
            WriteLiteral(@"ref=""../icon/folder-open-o""><i class=""fa fa-folder-open-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>folder-open-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cog""><i class=""f");
            WriteLiteral(@"a fa-gear"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>gear <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/graduation-cap""><i");
            WriteLiteral(@" class=""fa fa-graduation-cap"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>graduation-cap</a></div>
            ...
            WriteLiteral(@"
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-spock-o""><i class=""fa fa-hand-spock-o"" aria-hidden=""true""></i> <span class=""sr-only"">");
            WriteLiteral(@"Example of </span>hand-spock-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/h");
            WriteLiteral(@"dd-o""><i class=""fa fa-hdd-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hdd-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/history""><i class=""fa fa-history"" aria-hid");
            WriteLiteral(@"den=""true""></i> <span class=""sr-only"">Example of </span>history</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/h");
            WriteLiteral(@"ourglass-half""><i class=""fa fa-hourglass-2"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hourglass-2 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hourglass-o""><i class=""fa fa-hourglass-o"" aria-hidden=""true""></i> <span class=""sr-only"">Examp");
            WriteLiteral(@"le of </span>hourglass-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/id-card-o""><i class=""fa fa-id-card-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of ");
            WriteLiteral(@"</span>id-card-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/info-circle""><i class=""fa fa-info-circle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>i");
            WriteLiteral(@"nfo-circle</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/laptop""><i class=""fa fa-laptop"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>laptop</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/level-up""><i class=""fa fa-level-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>l");
            WriteLiteral(@"evel-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../i");
            WriteLiteral(@"con/lightbulb-o""><i class=""fa fa-lightbulb-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>lightbulb-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../ico");
            WriteLiteral(@"n/magic""><i class=""fa fa-magic"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>magic</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/reply-all""><i class=""fa fa-mail-reply-all"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mail-reply-all <span class=""text-muted"">(alias)<");
            ...
            WriteLiteral(@"ol-md-3 col-sm-4""><a href=""../icon/map-signs""><i class=""fa fa-map-signs"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>map-signs</a></div>
                    ...
                    <div class=""fa-hover col");
            WriteLiteral(@"-md-3 col-sm-4""><a href=""../icon/minus""><i class=""fa fa-minus"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>minus</a></div>
                    ...
                    <div class=""fa-hover col-m");
            WriteLiteral(@"d-3 col-sm-4""><a href=""../icon/mobile""><i class=""fa fa-mobile-phone"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mobile-phone <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/motorcycle""><i class=""fa fa-motorcycle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>motorcyc");
            WriteLiteral(@"le</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/object-group""><i class=""fa fa-object-group"" aria-hidden=""true""></i> <span class=""sr-on");
            WriteLiteral(@"ly"">Example of </span>object-group</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/paw""><i class=""fa fa-paw"" aria-hidden=""true""></i> <s");
            WriteLiteral(@"pan class=""sr-only"">Example of </span>paw</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/phone""><i class=""fa fa-phone"" aria-hidden=""true""></i> <span class=""sr");
            WriteLiteral(@"-only"">Example of </span>phone</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/plane""><i class=""fa fa-plane"" aria-hidden=""true""></i> ");
            WriteLiteral(@"<span class=""sr-only"">Example of </span>plane</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/plus-square-o""><i class=""fa fa-plus-square-o"" aria-hidden=""true""></i> <span class=""sr-only"">Exampl");
            WriteLiteral(@"e of </span>plus-square-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/qrcode""><i class=""fa fa-qrcode"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>qrcode</a></d");
            WriteLiteral(@"iv>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/quote-right""><i class=""fa fa-quote-right"" aria-hidden=""true""></i> <span class=""sr-only"">Ex");
            WriteLiteral(@"ample of </span>quote-right</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/times""><i class=""fa fa-remove"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>remove <span class=""t");
            WriteLiteral(@"ext-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/road""><i class=""fa fa-road"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </");
            WriteLiteral(@"span>road</a></div>
 ...
 ");
            WriteLiteral(@"                   <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/search-minus""><i class=""fa fa-search-minus"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>search-minus</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/server""><i class=""fa fa-server"" aria-hidden=""true""></i>");
            WriteLiteral(@" <span class=""sr-only"">Example of </span>server</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/share-square-o""><i class=""fa fa-share-square-o"" aria-hidden=");
            WriteLiteral(@"""true""></i> <span class=""sr-only"">Example of </span>share-square-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/shopping-cart""><i class=""fa fa-shopping-cart"" aria-hidde");
            WriteLiteral(@"n=""true""></i> <span class=""sr-only"">Example of </span>shopping-cart</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/signal""><i class=""fa fa-signal"" aria-hidden=""true""></i> <span cl");
            WriteLiteral(@"ass=""sr-only"">Example of </span>signal</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/snowflake-o""><i class=""fa fa-snowflake-o"" aria-hidden=""true""></i>");
            WriteLiteral(@" <span class=""sr-only"">Example of </span>snowflake-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/sort-amo");
            WriteLiteral(@"unt-asc""><i class=""fa fa-sort-amount-asc"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>sort-amount-asc</a></div>
                    ...
                    <di");
            WriteLiteral(@"v class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/sort-numeric-asc""><i class=""fa fa-sort-numeric-asc"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>sort-numeric-asc</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/spinner""><i class=""fa fa-spinner"" aria-hidden=""true""></i> <span class=");
            WriteLiteral(@"""sr-only"">Example of </span>spinner</a></div>
    ...
    ");
            WriteLiteral(@"                <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/star-half-o""><i class=""fa fa-star-half-empty"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>star-half-empty <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@""" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>sticky-note</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/life-ring""><i class=""fa fa-support"" aria-hidd");
            WriteLiteral(@"en=""true""></i> <span class=""sr-only"">Example of </span>support <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/tasks""><i class=""fa fa-tasks"" aria-hidden=""true""></i> <span cl");
            WriteLiteral(@"ass=""sr-only"">Example of </span>tasks</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-empty""><i class=""fa fa-thermometer-0"" ar");
            WriteLiteral(@"ia-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-0 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-full""><i class=""fa fa-");
            WriteLiteral(@"thermometer-4"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-4 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-quarter""><i class=""fa fa-thermometer-quarter"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermom");
            WriteLiteral(@"eter-quarter</a></div>
            ...
            WriteLiteral(@" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thumbs-o-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/times-circle-o""><i class=""fa fa-times-circle-o"" aria-hidden=""");
            WriteLiteral(@"true""></i> <span class=""sr-only"">Example of </span>times-circle-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-down""><i class=""fa fa-toggle-down"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>toggle-down <span class=""text-muted"">(alias)</s");
            WriteLiteral(@"pan></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-s");
            WriteLiteral(@"quare-o-up""><i class=""fa fa-toggle-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>toggle-up <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/trophy");
            WriteLiteral(@"""><i class=""fa fa-trophy"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>trophy</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/universal-access""><i class=""fa fa-u");
            WriteLiteral(@"niversal-access"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>universal-access</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../ico");
            WriteLiteral(@"n/upload""><i class=""fa fa-upload"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>upload</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/user-plus""><i class=""fa fa-");
            WriteLiteral(@"user-plus"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>user-plus</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/address-c");
            WriteLiteral(@"ard-o""><i class=""fa fa-vcard-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>vcard-o <span class=""text-muted"">(alias)</span></a></div>
        ...
        ");
            WriteLiteral(@"            <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/volume-up""><i class=""fa fa-volume-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>volume-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/wifi""><i class=""fa fa-wifi"" aria-hidden=""true""></i> <span class=""sr-only"">Example ");
            WriteLiteral(@"of </span>wifi</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/window-restore""><i class=""fa fa-window-restore"" ari");
            WriteLiteral(@"a-hidden=""true""></i> <span class=""sr-only"">Example of </span>window-restore</a></div>
            ...
            <section id=""accessibility"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/american-sign-language-interpreting""><i class=""fa fa-asl-interpreting"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>asl-interpreting <span class=");
            WriteLiteral(@"""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc""><i class=""fa fa-cc"" aria-hidden=""t");
            WriteLiteral(@"rue""></i> <span class=""sr-only"">Example of </span>cc</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/quest");
            WriteLiteral(@"ion-circle-o""><i class=""fa fa-question-circle-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>question-circle-o</a></div>
                 ...
                 ");
            WriteLiteral(@"   <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/volume-control-phone""><i class=""fa fa-volume-control-phone"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>volume-control-phone</a></div>
            ...
            <section id=""hand"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-rock-o""><i class=""fa fa-hand-grab-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </spa");
            WriteLiteral(@"n>hand-grab-o <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-o-up""><i class=""fa fa-hand-o-up"" a");
            WriteLiteral(@"ria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hand-o-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-scissors-");
            WriteLiteral(@"o""><i class=""fa fa-hand-scissors-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hand-scissors-o</a></div>
             ...
             ");
            WriteLiteral(@"       <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thumbs-o-up""><i class=""fa fa-thumbs-o-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thumbs-o-up</a></div>
            ...
            <section id=""transportation"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/car""><i class=""fa fa-automobile"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>automobile <span class=""text");
            WriteLiteral(@"-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/fighter-jet""><i class=""fa fa-fighter-jet"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>fighter-jet</a><");
            WriteLiteral(@"/div>
                    ...
                    <div c");
            WriteLiteral(@"lass=""fa-hover col-md-3 col-sm-4""><a href=""../icon/subway""><i class=""fa fa-subway"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>subway</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/wheelcha");
            WriteLiteral(@"ir-alt""><i class=""fa fa-wheelchair-alt"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>wheelchair-alt</a></div>
            ...
            <section id=""gender"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 c");
            WriteLiteral(@"ol-sm-4""><a href=""../icon/mars-double""><i class=""fa fa-mars-double"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mars-double</a></div>
                    ...
                    <div class=""fa-");
            WriteLiteral(@"hover col-md-3 col-sm-4""><a href=""../icon/neuter""><i class=""fa fa-neuter"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>neuter</a></div>
                    ...
                    <div class=""fa-ho");
            WriteLiteral(@"ver col-md-3 col-sm-4""><a href=""../icon/venus-mars""><i class=""fa fa-venus-mars"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>venus-mars</a></div>
            ...
            <section id=""file-type"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div cla");
            WriteLiteral(@"ss=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-code-o""><i class=""fa fa-file-code-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-code-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-o""><i class=""fa fa-file-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </spa");
            WriteLiteral(@"n>file-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a hr");
            WriteLiteral(@"ef=""../icon/file-audio-o""><i class=""fa fa-file-sound-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-sound-o <span class=""text-muted"">(alias)</span></a></div>
         ...
         ");
            WriteLiteral(@"           <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-archive-o""><i class=""fa fa-file-zip-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-zip-o <span class=""text-muted"">(alias)</span></a></div>
  ...
  ");
            ...
            <section id=""form-control"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/circle-o""><i class=""fa fa-circle-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>circle-o</a");
            WriteLiteral(@"></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/plus-square-o""><i class=""fa fa-plus-square-o"" aria-hidden=""true""></i> <span class=""sr-onl");
            WriteLiteral(@"y"">Example of </span>plus-square-o</a></div>
            ...
            <section id=""payment"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc-diners-club""><i class=""fa fa-cc-diners-club"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>cc-diners-club</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc-stripe""><i class=""fa fa-cc-stripe"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>cc-stripe</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/paypal""><i class=""fa fa-paypal"" aria-hidden=""true""></i> <span class=""sr-only"">");
            WriteLiteral(@"Example of </span>paypal</a></div>
            ...
            <section id=""chart"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/line-chart""><i class=""fa fa-line-chart"" aria-hidden");
            WriteLiteral(@"=""true""></i> <span class=""sr-only"">Example of </span>line-chart</a></div>
            ...
            <section id=""currency"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/jpy""><i class=""fa fa-cny"" aria-hidden=""tr");
            WriteLiteral(@"ue""></i> <span class=""sr-only"">Example of </span>cny <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/gg""><i class=""fa ");
            WriteLiteral(@"fa-gg"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>gg</a></div>
            ...
            WriteLiteral(@"
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/rub""><i class=""fa fa-ruble"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>ruble <span class=""text-mu");
            WriteLiteral(@"ted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/try""><i class=""fa fa-turkish-lira"" aria-hi");
            WriteLiteral(@"dden=""true""></i> <span class=""sr-only"">Example of </span>turkish-lira <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"id=""text-editor"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover c");
            WriteLiteral(@"ol-md-3 col-sm-4""><a href=""../icon/bold""><i class=""fa fa-bold"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bold</a></div>
                    ...
                    <div class=""fa-hover ");
            WriteLiteral(@"col-md-3 col-sm-4""><a href=""../icon/files-o""><i class=""fa fa-copy"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>copy <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file""><i class=""fa fa-file"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file</a></");
            WriteLiteral(@"div>
                  ...
                  ");
            WriteLiteral(@"  <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/font""><i class=""fa fa-font"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>font</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/list""><i cla");
            WriteLiteral(@"ss=""fa fa-list"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>list</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/paperclip""><i class=""fa fa-paperclip"" aria-hidden=""true""></i> ");
            WriteLiteral(@"<span class=""sr-only"">Example of </span>paperclip</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/repeat""><i cla");
            WriteLiteral(@"ss=""fa fa-rotate-right"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>rotate-right <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div");
            WriteLiteral(@" class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/superscript""><i class=""fa fa-superscript"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>superscript</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm");
            WriteLiteral(@"-4""><a href=""../icon/th-large""><i class=""fa fa-th-large"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>th-large</a></div>
     ...
     ");
            WriteLiteral(@"       <section id=""directional"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/angle-double-up""><i class=""fa fa-angle-double-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>angle-double-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/arrow-circle-down""><i class=""fa fa-arrow-circle-down"" aria-hidden=""true""></i> <span class=""sr");
            WriteLiteral(@"-only"">Example of </span>arrow-circle-down</a></div>
                    ...
                    <div class=""fa-hover co");
            WriteLiteral(@"l-md-3 col-sm-4""><a href=""../icon/arrow-circle-o-up""><i class=""fa fa-arrow-circle-o-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>arrow-circle-o-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/arrow-left""><i class=""fa fa-arrow-left"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>arrow-");
            WriteLiteral(@"left</a></div>
  ...
  ");
            WriteLiteral(@"                  <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/arrows-v""><i class=""fa fa-arrows-v"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>arrows-v</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-down""><i class=""fa fa-caret-square-o-down"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>caret-squa");
            WriteLiteral(@"re-o-down</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/chevron-circle-down""><i class=""f");
            WriteLiteral(@"a fa-chevron-circle-down"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>chevron-circle-down</a></div>
            ...
            WriteLiteral(@"
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-o-down""><i class=""fa fa-hand-o-down"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hand-o-do");
            WriteLiteral(@"wn</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/long-arrow-left""><i class=""fa fa-long-arrow-left"" aria-hidden=""true""></i> <span class=""sr-");
            WriteLiteral(@"only"">Example of </span>long-arrow-left</a></div>
                    ...
                    <d");
            WriteLiteral(@"iv class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-right""><i class=""fa fa-toggle-right"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>toggle-right <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>backward</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/fast-forward""><i class=""fa fa-fast-forward"" aria-hidden=""true""></");
            WriteLiteral(@"i> <span class=""sr-only"">Example of </span>fast-forward</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/play""><i class=""fa fa-play"" aria-hidden=""true""></i> <span class=");
            WriteLiteral(@"""sr-only"">Example of </span>play</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/step-forward""><i class=""fa fa-step-forward"" aria-hidden=""true""></i> <spa");
            WriteLiteral(@"n class=""sr-only"">Example of </span>step-forward</a></div>
            ...
            WriteLiteral(@"
                ...
                <div class=""row fontawesome-icon-list margin-bottom-lg"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/angellist""><i class=""fa fa-angellist"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>an");
            WriteLiteral(@"gellist</a></div>
            ...
            WriteLiteral(@"
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bluetooth-b""><i class=""fa fa-bluetooth-b"" aria-hidden=""true""></i> <span class=""sr-only""");
            WriteLiteral(@">Example of </span>bluetooth-b</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc-discover""><i class=""fa fa-cc-discover"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </");
            WriteLiteral(@"span>cc-discover</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc-visa""><i class=""fa fa-cc-visa"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cc-visa<");
            WriteLiteral(@"/a></div>
             ...
             ");
            WriteLiteral(@"       <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/css3""><i class=""fa fa-css3"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>css3</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-");
            WriteLiteral(@"4""><a href=""../icon/dribbble""><i class=""fa fa-dribbble"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>dribbble</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/empire""><i class=""fa fa-empire"" a");
            WriteLiteral(@"ria-hidden=""true""></i> <span class=""sr-only"">Example of </span>empire</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/facebook""><i class=""fa fa-facebook"" aria-h");
            WriteLiteral(@"idden=""true""></i> <span class=""sr-only"">Example of </span>facebook</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""");
            WriteLiteral(@"><a href=""../icon/first-order""><i class=""fa fa-first-order"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>first-order</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4");
            WriteLiteral(@"""><a href=""../icon/forumbee""><i class=""fa fa-forumbee"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>forumbee</a></div>
                    ...
                    <div class=");
            WriteLiteral(@"""fa-hover col-md-3 col-sm-4""><a href=""../icon/gg""><i class=""fa fa-gg"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>gg</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/github-alt""><");
            WriteLiteral(@"i class=""fa fa-github-alt"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>github-alt</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/");
            WriteLiteral(@"glide-g""><i class=""fa fa-glide-g"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>glide-g</a></div>
...
");
            WriteLiteral(@"
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hacker-news""><i class=""fa fa-hacker-news"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hacker-new");
            WriteLiteral(@"s</a></div>
              ...
              ");
            WriteLiteral(@"      <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/ioxhost""><i class=""fa fa-ioxhost"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>ioxhost</a></div>
                    ...
                    <div class=""fa-hover co");
            WriteLiteral(@"l-md-3 col-sm-4""><a href=""../icon/leanpub""><i class=""fa fa-leanpub"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>leanpub</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""");
            WriteLiteral(@"../icon/maxcdn""><i class=""fa fa-maxcdn"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>maxcdn</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/modx""><i class=""fa fa-modx"" aria-hidden");
            WriteLiteral(@"=""true""></i> <span class=""sr-only"">Example of </span>modx</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/opera""><i class=""fa fa-opera"" aria-");
            WriteLiteral(@"hidden=""true""></i> <span class=""sr-only"">Example of </span>opera</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/pied-piper-alt""><i class=""fa fa-pied-piper-alt"" aria-hi");
            WriteLiteral(@"dden=""true""></i> <span class=""sr-only"">Example of </span>pied-piper-alt</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/product-hunt""><");
            WriteLiteral(@"i class=""fa fa-product-hunt"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>product-hunt</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/rebel""><i class=""fa fa-rebel"" aria-hi");
            WriteLiteral(@"dden=""true""></i> <span class=""sr-only"">Example of </span>rebel</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/rebel""><i class=""fa fa-resistance"" aria-hidden=""true""></i> <");
            WriteLiteral(@"span class=""sr-only"">Example of </span>resistance <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/share-alt-square""><i class=""fa fa-share-alt-square"" aria-hidden");
            WriteLiteral(@"=""true""></i> <span class=""sr-only"">Example of </span>share-alt-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/slack""><i class=""fa fa-slack"" aria-hidden=""true""></i> <s");
            WriteLiteral(@"pan class=""sr-only"">Example of </span>slack</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/soundcloud""><i class=""fa fa-soundcloud"" aria-hidd");
            WriteLiteral(@"en=""true""></i> <span class=""sr-only"">Example of </span>soundcloud</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/steam-square""><i class=""fa fa-steam-square"" aria");
            WriteLiteral(@"-hidden=""true""></i> <span class=""sr-only"">Example of </span>steam-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/tencent-weibo""><i");
            WriteLiteral(@" class=""fa fa-tencent-weibo"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>tencent-weibo</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/tumblr-square""><i class=""fa fa-");
            WriteLiteral(@"tumblr-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>tumblr-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/viacoin""><i class=""fa fa-viacoin"" aria-hidden=""true");
            WriteLiteral(@"""></i> <span class=""sr-only"">Example of </span>viacoin</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/vine""><i class=""fa fa-vine"" aria-hidden=""true""></i> <span class=""sr-onl");
            WriteLiteral(@"y"">Example of </span>vine</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/whatsapp""><i class=""fa fa-whatsapp"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>whatsapp</a");
            WriteLiteral(@"></div>
            ...
            WriteLiteral(@"
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hacker-news""><i class=""fa fa-y-combinator-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>y-combinator-square <span cl");
            WriteLiteral(@"ass=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/yoast""><i class=""fa fa-yoast"" aria-hidden=""true""><");
            WriteLiteral(@"/i> <span class=""sr-only"">Example of </span>yoast</a></div>
                ...
                <div class=""alert alert-warning"">
                    <h4><i class=""fa fa-warning""");
            BeginWriteAttribute("aria-hidden\"true\"", " aria-hidden\"true\"=\"", 206692, "\"", 206712, 0);
            EndWriteAttribute();
            WriteLiteral(@"></i> Warning!</h4>
                ...
                <div class=""alert alert-success"">
                    <ul class=""margin-bottom-none padding-left-lg"">
                        ...
                        <li class");
            WriteLiteral(@"=""strong"">Please do not use brand logos for any purpose except to represent that particular brand or service.</li>
                    </ul>
            ...
            <section id=""medical"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hear");
            WriteLiteral(@"t-o""><i class=""fa fa-heart-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>heart-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/stethoscope""><i class=""f");
            WriteLiteral(@"a fa-stethoscope"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>stethoscope</a></div>
